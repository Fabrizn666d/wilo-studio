      ...
      <div className={styles.contactGrid}>
        ...
        <div className={styles.contactActions}>
          <div className={styles.optionGrid}>
            ...
            <article className={styles.contactOption} data-reveal="cards"><span className={styles.optionNumber}>02<FileText /></span><h3>QUIERO<br />COTIZAR</h3><p>Ya sé lo que necesito. Quiero una propuesta formal para mi proyecto.</p><Link href="/contacto#cotizador" className={styles.quoteLink}>Iniciar proyecto<ArrowRight size={19} /></Link></article>
          </div>
