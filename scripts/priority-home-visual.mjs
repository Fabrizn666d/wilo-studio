...
const output = "artifacts/visual/priority-home";
...
async function capture(viewport, suffix) {
  ...
  const targets = [
    ["trabajos", '[aria-labelledby="work-title"]'],
    ["proyectos", '[aria-labelledby="projects-depth-title"]'],
    ["servicios", '[aria-labelledby="capabilities-title"]'],
    ["lab", '[aria-labelledby="lab-title"]'],
    ["proceso", "#proceso"],
  ];
